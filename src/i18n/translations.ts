const en = {
  ...
  booking: {
    ...
    body: 'Send the details below and we will save your request in our reservation system. We will confirm availability by phone or email.',
    name: 'Full name',
    phone: 'Phone number',
    email: 'Email address',
    ...
    optional: 'Optional',
    placeholders: { name: 'Your name', phone: '+371 20 000 000', email: 'you@example.com', vehicle: 'e.g. Volvo XC60', message: 'Tell us about the vehicle condition or your priorities.' },
    submit: 'Send booking request',
    submitting: 'Sending request…',
    submitted: 'Your booking request has been received.',
    submittedDetail: 'We will review the details and contact you to confirm the date and final scope.',
    errors: {
      name: 'Enter your full name.', phone: 'Enter a valid phone number.', email: 'Enter a valid email address.', vehicle: 'Enter the vehicle make and model.', services: 'Select at least one service.', date: 'Choose today or a future date.', consent: 'Consent is required so we can respond.', duplicate: 'This booking request was already sent. Change a detail before sending it again.', generic: 'We could not save your request. Please try again or email us at',
    },
  },
  footer: {
    ...
    placeholder: 'Placeholder details—replace before launch.',
  },
  privacy: {
    title: 'Privacy policy placeholder',
    body: 'Booking details are transmitted to Google Forms and stored in the studio’s linked Google Sheet so the team can respond. Before launch, replace this notice with a complete policy covering the final controller details, legal basis, retention period and data-subject rights.',
...
const lv: typeof en = {
  ...
  booking: {
    eyebrow: 'Vizītes pieteikums', title: 'Pastāstiet par savu auto.',
    body: 'Aizpildiet informāciju, un mēs saglabāsim pieteikumu rezervāciju sistēmā. Pieejamību apstiprināsim pa tālruni vai e-pastu.',
    name: 'Vārds, uzvārds', phone: 'Tālruņa numurs', email: 'E-pasta adrese', vehicle: 'Auto marka un modelis', services: 'Izvēlētie pakalpojumi', date: 'Vēlamais datums', message: 'Papildu ziņa', consent: 'Piekrītu, ka VELORA izmanto šos datus, lai atbildētu uz manu pieteikumu.', optional: 'Nav obligāti',
    placeholders: { name: 'Jūsu vārds', phone: '+371 20 000 000', email: 'jusu@epasts.lv', vehicle: 'piem., Volvo XC60', message: 'Aprakstiet auto stāvokli vai svarīgāko rezultātu.' },
    submit: 'Nosūtīt pieteikumu', submitting: 'Nosūtām pieteikumu…', submitted: 'Jūsu pieteikums ir saņemts.', submittedDetail: 'Pārskatīsim informāciju un sazināsimies, lai apstiprinātu datumu un gala darbu apjomu.',
    errors: { name: 'Ievadiet vārdu un uzvārdu.', phone: 'Ievadiet derīgu tālruņa numuru.', email: 'Ievadiet derīgu e-pasta adresi.', vehicle: 'Ievadiet auto marku un modeli.', services: 'Izvēlieties vismaz vienu pakalpojumu.', date: 'Izvēlieties šodienu vai vēlāku datumu.', consent: 'Piekrišana ir vajadzīga, lai varam atbildēt.', duplicate: 'Šis pieteikums jau tika nosūtīts. Pirms atkārtotas nosūtīšanas mainiet kādu informāciju.', generic: 'Neizdevās saglabāt pieteikumu. Mēģiniet vēlreiz vai rakstiet uz' },
  },
  footer: {
    description: 'Premium auto kopšanas studija Rīgā, kas koncentrējas uz kontrolētu korekciju, rūpīgu tīrīšanu un noturīgu virsmu aizsardzību.', visit: 'Apmeklējums', contact: 'Kontakti', hours: 'Darba laiks', weekday: 'P.–Pk. · 09:00–19:00', saturday: 'S. · 10:00–16:00', sunday: 'Sv. · Slēgts', follow: 'Sekot Instagram', privacy: 'Privātuma politika', rights: 'Visas tiesības aizsargātas.', placeholder: 'Viettura dati — nomainiet pirms palaišanas.',
  },
  privacy: {
    title: 'Privātuma politikas vietturis', body: 'Pieteikuma dati tiek nosūtīti uz Google Forms un glabāti studijas saistītajā Google izklājlapā, lai komanda varētu atbildēt. Pirms palaišanas aizstājiet šo paziņojumu ar pilnu politiku par pārzini, tiesisko pamatu, glabāšanas termiņu un datu subjekta tiesībām.', close: 'Aizvērt privātuma politiku',
  },
}
...
const ru: typeof en = {
  ...
  booking: {
    eyebrow: 'Запрос на запись', title: 'Расскажите об автомобиле.', body: 'Заполните данные, и мы сохраним запрос в системе бронирования. Мы подтвердим доступность по телефону или электронной почте.', name: 'Имя и фамилия', phone: 'Номер телефона', email: 'Электронная почта', vehicle: 'Марка и модель автомобиля', services: 'Выбранные услуги', date: 'Желаемая дата', message: 'Дополнительное сообщение', consent: 'Я разрешаю VELORA использовать эти данные, чтобы ответить на мой запрос.', optional: 'Необязательно',
    placeholders: { name: 'Ваше имя', phone: '+371 20 000 000', email: 'you@example.com', vehicle: 'например, Volvo XC60', message: 'Опишите состояние автомобиля или желаемый результат.' },
    submit: 'Отправить запрос', submitting: 'Отправляем запрос…', submitted: 'Ваш запрос на запись получен.', submittedDetail: 'Мы проверим данные и свяжемся с вами, чтобы подтвердить дату и окончательный объём работ.',
    errors: { name: 'Введите имя и фамилию.', phone: 'Введите корректный номер телефона.', email: 'Введите корректный адрес почты.', vehicle: 'Введите марку и модель автомобиля.', services: 'Выберите хотя бы одну услугу.', date: 'Выберите сегодняшнюю или будущую дату.', consent: 'Согласие необходимо, чтобы мы могли ответить.', duplicate: 'Этот запрос уже был отправлен. Измените данные перед повторной отправкой.', generic: 'Не удалось сохранить запрос. Попробуйте ещё раз или напишите на' },
  },
  footer: {
    description: 'Премиальная студия автодетейлинга в Риге: контролируемая коррекция, тщательная очистка и долговременная защита поверхностей.', visit: 'Адрес', contact: 'Контакты', hours: 'Время работы', weekday: 'Пн–Пт · 09:00–19:00', saturday: 'Сб · 10:00–16:00', sunday: 'Вс · Закрыто', follow: 'Instagram', privacy: 'Политика конфиденциальности', rights: 'Все права защищены.', placeholder: 'Данные-заполнители — заменить перед запуском.',
  },
  privacy: {
    title: 'Заполнитель политики конфиденциальности', body: 'Данные заявки передаются в Google Forms и хранятся в связанной Google-таблице студии, чтобы команда могла ответить. До запуска замените это уведомление полной политикой с данными оператора, правовым основанием, сроком хранения и правами субъектов данных.', close: 'Закрыть политику конфиденциальности',
  },
}
