const en = {
  ...
  privacy: {
    ...
    processingBody: 'Netlify processes reservation requests and Supabase stores the submitted booking data. Access to customer and reservation records is restricted to active administrators. Server credentials are never sent to the browser.',
...
const lv: typeof en = {
  ...
  footer: {
    description: 'Premium auto kopšanas studija Rīgā, kas koncentrējas uz kontrolētu korekciju, rūpīgu tīrīšanu un noturīgu virsmu aizsardzību.', visit: 'Apmeklējums', contact: 'Kontakti', hours: 'Darba laiks', weekday: 'P.–Pk. · 10:00–20:00', saturday: 'S. · 10:00–20:00', sunday: 'Sv. · 10:00–20:00', follow: 'Sekot Instagram', privacy: 'Privātuma politika', rights: 'Visas tiesības aizsargātas.', placeholder: 'Īpašnieka darbība: pirms komerciālas palaišanas aizpildiet publisko kontaktinformāciju.',
  },
  privacy: {
    ...
    processingTitle: 'Apstrādes pakalpojumi', processingBody: 'Netlify apstrādā rezervācijas pieprasījumus, un Supabase glabā iesniegtos rezervācijas datus. Klientu un rezervāciju ierakstiem var piekļūt tikai aktīvi administratori. Servera piekļuves dati netiek nosūtīti pārlūkprogrammai.',
...
const ru: typeof en = {
  ...
  privacy: {
    ...
    processingTitle: 'Сервисы обработки', processingBody: 'Netlify обрабатывает запросы на запись, а Supabase хранит отправленные данные бронирования. Доступ к данным клиентов и записям есть только у активных администраторов. Серверные ключи не передаются в браузер.',
