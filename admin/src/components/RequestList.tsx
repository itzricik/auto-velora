      ...
      <div className="request-grid">
        {requests.map((request) => (
          <article className="request-card" key={request.id}>
            ...
            <div className="request-meta"><span><CalendarDays size={15} /> Preferred {request.preferred_date}</span><strong>€{(request.estimated_total_cents / 100).toFixed(2)}</strong></div>
